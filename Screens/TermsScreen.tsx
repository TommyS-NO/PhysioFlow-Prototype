	...
	return (
		<ScrollView contentContainerStyle={styles.container}>
			...
			<Text style={styles.text}>
				...
				<Text>Last updated: February 20, 2024</Text>
				<Text>
				...
				<Text>
					<Text style={styles.strong}>Application</Text> refers to Project_x,
					the software program provided by the Company.
				</Text>
				<Text>
					<Text style={styles.strong}>Company</Text> (referred to as either "the
					Company", "We", "Us" or "Our" in this Agreement) refers to Gokstad
					Akademiet, Torget 1.
				</Text>
				<Text>
					<Text style={styles.strong}>Country</Text> refers to: Norway
				</Text>
				<Text>
				...
				<Text>
					<Text style={styles.strong}>Third-party Social Media Service</Text>{" "}
				...
				<Text>Information from your Device's phone book (contacts list)</Text>
				<Text>
