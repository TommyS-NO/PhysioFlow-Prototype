export const recommendedLowBackExercises = {
	"Gentle stretching av ryggmusklene": {
		description:
			"Utfør en serie med rolige strekk for nedre rygg. En effektiv øvelse er 'katten og kamelen': På alle fire, " +
			"vekselvis bue ryggen oppover og deretter senke den nedover, hold hver posisjon i noen sekunder.",
		image: "http://localhost:3000/static/assets/12501301.gif",
	},
	"Islegging for å redusere inflammasjon": {
		description:
			"Legg en ispakke innpakket i et håndkle på det smertefulle området i nedre rygg. " +
			"Hold isen på i 20 minutter, fjern den i minst en time før du gjentar om nødvendig.",
		image: "http://localhost:3000/static/assets/12501301.gif",
	},
	...
	"Kjerneforsterkende øvelser": {
		description:
			"Utfør øvelser som styrker kjerne-muskulaturen og forbedrer stabiliteten i nedre rygg, som planken, bro, og pilates.",
		image: "http://localhost:3000/static/assets/12501301.gif",
	},
	"Gentle stretching av hamstring": {
		description:
			"Sitt på gulvet med ett ben utstrakt, bøy forsiktig fremover fra hoften mot foten til det strakte benet. " +
			"Hold i 20-30 sekunder og gjenta på det andre benet.",
		image: "http://localhost:3000/static/assets/12501301.gif",
	},
