		...
		<View style={styles.container}>
			<View style={styles.textContainer}>
				<Text style={styles.title}>
					Viktig informasjon om sletting av konto
				</Text>
				<ScrollView>
					<Text style={styles.header}> Permanent sletting:</Text>
					<Text style={styles.text}>
						Når du sletter din profil, vil all personlig informasjon,
						treningshistorikk, og fremskritt bli permanent fjernet. Denne
						handlingen kan ikke omgjøres.
					</Text>
					<Text style={styles.header}>Data og personvern:</Text>
					<Text style={styles.text}>
						I tråd med personvernloven, vil all din personlige informasjon bli
						behandlet konfidensielt og sikkert. Ved sletting av din profil, vil
						dine data bli slettet fra våre servere i henhold til vår
						personvernspolicy.
					</Text>
					<Text style={styles.header}>Tilbakemelding:</Text>
					<Text style={styles.text}>
						Din tilbakemelding er verdifull for oss. Vi setter pris på om du kan
						dele hvorfor du velger å forlate vår plattform, slik at vi kan
						fortsette å forbedre vår tjeneste.
					</Text>
					<Text style={styles.warningText}>
						Vær oppmerksom på at ved å slette din profil vil du miste all din
						data og historikk. Denne handlingen kan ikke angres.
					</Text>
					<TouchableOpacity
