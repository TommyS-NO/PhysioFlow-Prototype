...
// 								<ScrollView>
// 									<Text style={frontScreenStyles.text}>
// 										Velkommen til PhysioFlow - din digitale partner for
// 										fysioterapi og rehabilitering, når og hvor det passer deg.{" "}
// 									</Text>
// 									<Text style={frontScreenStyles.text}>
// 										Ved å kombinere det nyeste innen kunstig intelligens (AI)
// 										med ekspertisen til vårt team av fysioterapeuter, har vi
// 										skapt en unik plattform designet for å gi deg personlig
// 										tilpasset veiledning og støtte gjennom din
...
// 									<Text style={frontScreenStyles.text}>
// 										I en verden hvor tilgangen til helsehjelp stadig utfordres
// 										av både tid og sted, er vår visjon å bringe fysioterapien
// 										hjem til deg. PhysioFlow ble grunnlagt med en formening om
// 										at alle fortjener tilgang til kvalitetsmessig fysioterapi,
// 										uavhengig av hvor de befinner seg.
// 									</Text>
// 									<Text style={frontScreenStyles.heading}>
// 										Hvordan PhysioFlow fungerer
// 									</Text>
// 									<Text style={frontScreenStyles.bulletPoints}>
// 										Personlig tilpasning:
// 									</Text>
// 									<Text style={frontScreenStyles.text}>
// 										Når du laster ned PhysioFlow-appen og oppretter din profil,
// 										blir du bedt om å dele informasjon om din fysiske tilstand,
// 										dine mål og eventuelle smerter eller skader. Denne
// 										informasjonen danner grunnlaget for din personlige
// 										rehabiliteringsplan.
// 									</Text>
...
// 									</Text>
// 									<Text style={frontScreenStyles.text}>
// 										Med PhysioFlow i lommen, har du tilgang til fysioterapi
// 										døgnet rundt, uten behov for å tilpasse deg tidsskjemaer
// 										eller reise til en klinikk. Enten du er hjemme, på jobb,
// 										eller på reise, gir vi deg verktøyene du trenger for å jobbe
// 										mot bedre helse.
// 									</Text>
// 									<Image
...
// 										instruksjonsvideoer og oppfølgingsverktøy som hjelper deg å
// 										holde deg på sporet. AI-teknologien muliggjør også
// 										tilpasning av programmet ditt over tid basert på din
// 										progresjon og eventuelle tilbakemeldinger du gir.
// 									</Text>

// 									<Text style={frontScreenStyles.heading}>Vårt team</Text>
// 									<Text style={frontScreenStyles.text}>
// 										Bak PhysioFlow står et dedikert team av fysioterapeuter,
// 										dataforskere og teknologientusiaster, alle med et felles mål
// 										om å gjøre rehabilitering så tilgjengelig og effektiv som
// 										mulig. Vi er stolte av å kunne tilby en tjeneste som ikke
// 										bare leder an i teknologisk innovasjon, men som også er dypt
// 										forankret i profesjonell fysioterapipraksis.
// 									</Text>
// 									<Image
...
// 									<Text style={frontScreenStyles.bulletPoints}>
// 										<Text style={frontScreenStyles.boldText}>Telefon:</Text>{" "}
// 										123-456-7890
// 									</Text>
// 									<Text style={frontScreenStyles.bulletPoints}>
// 										<Text style={frontScreenStyles.boldText}>E-post:</Text>{" "}
// 										contact@example.com
// 									</Text>
// 									<Text style={frontScreenStyles.bulletPoints}>
// 										<Text style={frontScreenStyles.boldText}>Adresse:</Text>{" "}
// 										Eksempelveien 123, 0123 Sted
// 									</Text>
