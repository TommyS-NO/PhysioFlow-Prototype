...
const FocusScreen = () => {
	...
	const handleSubmitAnswers = async () => {
		try {
			...
			// Dispatch the diagnosis information to global state
			dispatch({
				type: "LOAD_DIAGNOSIS",
				diagnosis: {
			...
			// Optionally, also set the local state if necessary
			setDiagnosisResult({
...
//Kode med sidemerking som ser veldig ryddig og fin ut. Koden over fungerer men mangler litt styling.
